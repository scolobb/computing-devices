...
u22compressed = StateGraph (Map.fromList [ ((1,1),Set.fromList [ Transition (IntMap.fromList [(1,MultiSet.fromOccurList [(Dec,1)]),(7,MultiSet.fromOccurList [(Inc,1)])])
...
u20compressed = StateGraph (Map.fromList [ ((1,1),Set.fromList [ Transition (IntMap.fromList [(1,MultiSet.fromOccurList [(Dec,1)]),(7,MultiSet.fromOccurList [(Inc,1)])])
                                                                (IntMap.fromList [(1,NotZero)]) ])
                                         , ((1,4),Set.fromList [ Transition (IntMap.fromList [(6,MultiSet.fromOccurList [(Inc,1)])])
                                                                 (IntMap.fromList [(1,Zero)]) ])
                                         , ((4,4),Set.fromList [ Transition (IntMap.fromList []) (IntMap.fromList [(5,Zero),(6,Zero)])
